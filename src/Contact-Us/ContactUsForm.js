      ...
      <div>
        <form className="form-submission">
          ...
          <label className="label-for-input">
            Name
            <input className="input-field" type="text" name="name" placeholder="Enter your name" value={name} onChange={(event)=>updatename(event)}/>
          </label>
          <label className="label-for-input">
            Email
            <input className="input-field" type="email" name="Email" placeholder=" Enter your email" value={email} onChange={(event)=>updateemail(event)} />
          </label>
          <label className="label-for-input">
            Enquiry
            <input className="input-field" type="text" name="Enquiry" placeholder="Enter your enquiry" value={enquiry} onChange={(event)=>updateenquiry(event)} />
          </label>
          <label className="label-for-input">
            Message
            <input className="input-field" type="text" name="Message" placeholder="Enter your message" value={message} onChange={(event)=>updatemessage(event)} />
          </label>
